...
import { NameFloatingInput } from "@cms/modules/properties/form/";
...
describe("NameFloatingInput", () => {
  test("edits really edit the property", () => {
    const mockProperty = createMockProperty({ name: { en: "Initial Name" } });
    const { store } = renderWithProviders(<NameFloatingInput />, { customProperty: mockProperty });
