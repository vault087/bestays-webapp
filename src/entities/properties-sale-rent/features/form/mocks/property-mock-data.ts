...
export function createMockProperty(id: string, overrides?: Partial<MutableProperty>): MutableProperty {
  const defaultProperty: MutableProperty = {
    id,
...
// Test properties
export const mockProperties: Record<string, MutableProperty> = {
