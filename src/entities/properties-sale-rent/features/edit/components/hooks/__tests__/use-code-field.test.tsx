...
import { DBPropertyCodeField, useCodeField } from "@/entities/properties-sale-rent/";
import {
  withFieldProviders,
  createTestProperty,
...
describe("useCodeField", () => {
  ...
  describe("Field validation", () => {
    const allCodeFields: DBPropertyCodeField[] = ["area", "ownership_type", "property_type", "divisible_sale"];
